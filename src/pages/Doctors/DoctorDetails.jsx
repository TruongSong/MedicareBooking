            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <div className="flex items-center gap-[6px]">
                  ...
                  text-[14px] leading-5 lg:text-[16px] lg:leading-7
                ...
                lg:max-w-[390px]"
                >
                  Hi Muhib I would like to express my sincere gratitude for the
                  valuable learning experience you have provided
                </p>
              </div>
            </div>
